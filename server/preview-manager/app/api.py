...
from app.routes import auth, base_files, cli, config, gitlab, orgs, previews, webhooks
...
router.include_router(cli.internal_router)
router.include_router(config.router)
router.include_router(gitlab.router)
router.include_router(previews.router)
router.include_router(previews.global_router)
